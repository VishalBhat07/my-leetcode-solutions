...
#define MAX 10000000000000LL
    ...
    long long mincost(vector<int>& robot, int robo_pos, vector<int>& factories,
                      int fact_pos, vector<vector<long long>>& mem) {
        ...
        long long exclude =
            mincost(robot, robo_pos, factories, fact_pos - 1, mem);
...
public:
    long long minimumTotalDistance(vector<int>& robot,
        ...
        vector<vector<long long>> mem(robot.size(),
                                      vector<long long>(factories.size(), -1));
